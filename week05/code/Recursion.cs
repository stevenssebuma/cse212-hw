...
public static class Recursion
{
    ...
    {
        // Base case: if the size is 0, add the word to results
        if (size == 0)
        {
            results.Add(word);
            return;
        ...
        // Recursive case: iterate through each letter and generate permutations
    ...
    public static decimal CountWaysToClimb(int s, Dictionary<int, decimal>? remember = null)
    {
        ...
        // Recursive case: calculate the number of ways to climb the stairs
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        // Recurse with the updated patterns
